...
HD_PWD='C:/Users/ljh/Desktop/mnist_lstm/mnist_lstm/mnist_lstm.runs/design_1_LSTM_Top_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_LSTM_Top_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_LSTM_Top_0_5.tcl
