...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LSTM_Top.autotvin.dat"
	set constFileTvOut       "LSTM_Top.autotvout.dat"
	set constFileHdlTvIn     "LSTM_Top.autohdltvin.dat"
	set constFileHdlTvOut    "LSTM_Top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
