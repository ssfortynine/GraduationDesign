set moduleName infer_Pipeline_VITIS_LOOP_22_11
set isTopModule 0
...
set C_modelName {infer_Pipeline_VITIS_LOOP_22_11}
set C_modelType { void 0 }
set C_modelArgList {
	{ vec_tmp float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ gate_i float 32 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "vec_tmp", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "gate_i", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ gate_i_address0 sc_out sc_lv 7 signal 1 } 
	{ gate_i_ce0 sc_out sc_logic 1 signal 1 } 
	{ gate_i_we0 sc_out sc_logic 1 signal 1 } 
	{ gate_i_d0 sc_out sc_lv 32 signal 1 } 
...
set Spec2ImplPortList { 
	...
	gate_i { ap_memory {  { gate_i_address0 mem_address 1 7 }  { gate_i_ce0 mem_ce 1 1 }  { gate_i_we0 mem_we 1 1 }  { gate_i_d0 mem_din 1 32 } } }
}
