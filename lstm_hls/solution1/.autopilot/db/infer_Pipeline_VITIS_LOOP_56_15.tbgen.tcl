set moduleName infer_Pipeline_VITIS_LOOP_56_15
set isTopModule 0
...
set C_modelName {infer_Pipeline_VITIS_LOOP_56_15}
set C_modelType { void 0 }
set C_modelArgList {
	{ vec_tmp float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ gate_o float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ h_t float 32 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "vec_tmp", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "gate_o", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "h_t", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ gate_o_q0 sc_in sc_lv 32 signal 1 } 
	{ h_t_address0 sc_out sc_lv 7 signal 2 } 
	{ h_t_ce0 sc_out sc_logic 1 signal 2 } 
	{ h_t_we0 sc_out sc_logic 1 signal 2 } 
	{ h_t_d0 sc_out sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	gate_o { ap_memory {  { gate_o_address0 mem_address 1 7 }  { gate_o_ce0 mem_ce 1 1 }  { gate_o_q0 in_data 0 32 } } }
	h_t { ap_memory {  { h_t_address0 mem_address 1 7 }  { h_t_ce0 mem_ce 1 1 }  { h_t_we0 mem_we 1 1 }  { h_t_d0 mem_din 1 32 } } }
}
