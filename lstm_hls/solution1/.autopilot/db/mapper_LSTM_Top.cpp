...
auto* sout_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_V_dest_V);
  // DUT call
  LSTM_Top(sin_V_data_V->data<int>(), sin_V_keep_V->data<char>(), sin_V_strb_V->data<char>(), sin_V_user_V->data<char>(), sin_V_last_V->data<char>(), sin_V_id_V->data<char>(), sin_V_dest_V->data<char>(), sout_V_data_V->data<int>(), sout_V_keep_V->data<char>(), sout_V_strb_V->data<char>(), sout_V_user_V->data<char>(), sout_V_last_V->data<char>(), sout_V_id_V->data<char>(), sout_V_dest_V->data<char>());
