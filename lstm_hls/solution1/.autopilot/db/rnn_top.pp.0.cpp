...
{
 float buf_in[20 * 5], res[1];


 VITIS_LOOP_10_1: for (int i = 0; i < 20 * 5; i++)
 {
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_22_2: for (int i = 0; i < 1; i++)
 {
#pragma HLS PIPELINE II=1
 out.write(push_stream <T, U, TI, TD> (res[i], (i == 1 - 1)));
 }
...
__attribute__((sdx_kernel("LSTM_Top", 0))) void LSTM_Top(hls::stream<stream_t> &in, hls::stream<stream_t> &out)
{
#line 21 "D:/BaiduNetdiskDownload/GraduationDesign/lstm_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=LSTM_Top
# 33 "lstm_hls/rnn_top.cpp"

#line 7 "D:/BaiduNetdiskDownload/GraduationDesign/lstm_hls/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=LSTM_Top
# 33 "lstm_hls/rnn_top.cpp"
