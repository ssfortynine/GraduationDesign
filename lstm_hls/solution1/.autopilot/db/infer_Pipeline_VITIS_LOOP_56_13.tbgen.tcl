set moduleName infer_Pipeline_VITIS_LOOP_56_13
set isTopModule 0
...
set C_modelName {infer_Pipeline_VITIS_LOOP_56_13}
set C_modelType { void 0 }
set C_modelArgList {
	{ gate_i float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ stat_C float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ C_t float 32 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gate_i", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "stat_C", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "C_t", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ gate_i_address0 sc_out sc_lv 7 signal 0 } 
	{ gate_i_ce0 sc_out sc_logic 1 signal 0 } 
	{ gate_i_q0 sc_in sc_lv 32 signal 0 } 
	{ stat_C_address0 sc_out sc_lv 7 signal 1 } 
	{ stat_C_ce0 sc_out sc_logic 1 signal 1 } 
	{ stat_C_q0 sc_in sc_lv 32 signal 1 } 
	{ C_t_address0 sc_out sc_lv 7 signal 2 } 
	{ C_t_ce0 sc_out sc_logic 1 signal 2 } 
	{ C_t_we0 sc_out sc_logic 1 signal 2 } 
	{ C_t_d0 sc_out sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	gate_i { ap_memory {  { gate_i_address0 mem_address 1 7 }  { gate_i_ce0 mem_ce 1 1 }  { gate_i_q0 in_data 0 32 } } }
	stat_C { ap_memory {  { stat_C_address0 mem_address 1 7 }  { stat_C_ce0 mem_ce 1 1 }  { stat_C_q0 in_data 0 32 } } }
	C_t { ap_memory {  { C_t_address0 mem_address 1 7 }  { C_t_ce0 mem_ce 1 1 }  { C_t_we0 mem_we 1 1 }  { C_t_d0 mem_din 1 32 } } }
}
