set moduleName infer_Pipeline_1
set isTopModule 0
...
set C_modelName {infer_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gate_f float 32 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gate_f", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ gate_f_address0 sc_out sc_lv 7 signal 0 } 
	{ gate_f_ce0 sc_out sc_logic 1 signal 0 } 
	{ gate_f_we0 sc_out sc_logic 1 signal 0 } 
	{ gate_f_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	gate_f { ap_memory {  { gate_f_address0 mem_address 1 7 }  { gate_f_ce0 mem_ce 1 1 }  { gate_f_we0 mem_we 1 1 }  { gate_f_d0 mem_din 1 32 } } }
}
