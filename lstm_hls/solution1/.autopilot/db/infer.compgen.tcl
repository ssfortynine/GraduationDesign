...
set name LSTM_Top_faddfsub_32ns_32ns_32_5_full_dsp_1
...
set name LSTM_Top_fdiv_32ns_32ns_32_10_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fdiv} IMPL {fabric} LATENCY 9 ALLOW_PRAGMA 1
}


set name LSTM_Top_fexp_32ns_32ns_32_8_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler LSTM_Top_infer_vec_i_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
